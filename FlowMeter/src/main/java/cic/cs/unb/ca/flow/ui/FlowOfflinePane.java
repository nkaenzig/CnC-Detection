...
public class FlowOfflinePane extends JPanel{
    ...
    private JPanel initCtrlPane(){
        ...
        optPane.add(initTimesPane());
        optPane.add(SubnetsPane());
    ...
    private JPanel initTimesPane(){

        JPanel jPanel = new JPanel();
        jPanel.setLayout(new BoxLayout(jPanel,BoxLayout.X_AXIS));
        jPanel.setBorder(PADDING);

        JLabel lb11 = new JLabel("Start-time (h:mm dd/MM/yy): ");
        startField = new JTextField(1);
        startField.setEditable(true);

        JLabel lb12 = new JLabel("End-time (h:mm dd/MM/yy): ");
        endField = new JTextField(1);
        endField.setEditable(true);

        jPanel.add(lb11);
        jPanel.add(startField);
//        jPanel.add(Box.createHorizontalGlue());
        jPanel.add(Box.createRigidArea(new Dimension(48,0)));
        jPanel.add(lb12);
        jPanel.add(endField);
    ...
    private JPanel SubnetsPane(){

        JPanel jPanel = new JPanel();
        jPanel.setLayout(new BoxLayout(jPanel,BoxLayout.X_AXIS));
        jPanel.setBorder(PADDING);

        JLabel lb11 = new JLabel("Internal subnets (CIDR, comma-separated): ");
        subnetsField = new JTextField(1);
        subnetsField.setEditable(true);

        jPanel.add(lb11);
        jPanel.add(subnetsField);
...
//        in = new File("C:\\Users\\Nicolas\\workspace\\Network_Analyzer\\data"); // NK
...
//        out = new File("C:\\Users\\Nicolas\\workspace\\Network_Analyzer\\data"); // NK
        ...
        try {
            ...
            subnets = subnetsField.getText();

            ReadPcapFileWorker worker = new ReadPcapFileWorker(in, out.getPath(), flowTimeout, activityTimeout, startTime, endTime, subnets);
